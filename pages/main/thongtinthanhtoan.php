        ...
        <form action="pages/main/xulythanhtoan.php" method="POST">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <h5 style="margin-top: 2em;">Giỏ hàng của bạn</h5>
                    <table style="width:100%;text-align: center;border-collapse: collapse;" border="1">
                        ...
                        ?>
                            ...
                            <tr>
                                <td colspan="8">
                                    <p style="float: left;text-align: center;width: 100%;font-size: 2em;">Tổng tiền: <?php echo number_format($tongtien, 0, ',', '.') . 'vnđ' ?></p><br />
                ...
                <div class="col-md-4 hinhthucthanhtoan">
                    ...
                    <div class="form-check">
                        ...
                        <label style="pointer-events: none;" class="form-check-label" for="exampleRadios4">
                            Ví điện tử Đang phát triển
                        </label>
                    </div>
                    <input type="submit" value="Thanh toán ngay" name="redirect" class="btn btn-danger">

                    <a href="index.php?quanly=vanchuyen" class="btn-next" >Sửa thông tin</a>
