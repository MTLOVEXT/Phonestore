...
<table style="width:100%" border="1" style="border-collapse: collapse;">
  ...
  ?>
    <tr>
      ...
      <td>
        <a href="modules/quanlyuser/xuly.php?idkh=<?php echo $row['id_dangky'] ?>">Xóa</a>| <a href="
        ?action=quanlyuser&query=sua&id=<?php echo $row['id_dangky'] ?>">Sửa</a> 
      </td>
...
<p><a href="#" onclick="document.getElementById('modal-nv').style.display='block'">Thêm khách hàng</a></p>
...
<div id="modal-nv" class="modal-kh">
    <form method="POST" action="./modules/quanlyuser/xuly.php">
        ...
        <div class="container">
            <table class="fmthemnv">
                ...
                <tr class="fmthemnv__tr">
                    <td><button type="button" onclick="document.getElementById('modal-nv').style.display='none'">Hủy thêm khách hàng </button></td>
                    <td><button type="submit" id="themkh" name="themkh" value="Đăng ký">Thêm khách hàng</button></td>
                </tr>
            </table>
        </div>
    </form>
